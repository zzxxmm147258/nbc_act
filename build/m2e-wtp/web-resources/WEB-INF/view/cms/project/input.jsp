...
<div class="ibox-content" id="infoContainer">
    <form method="post" action="${prc}/main/project/editor" class="form-horizontal" id="mainForm" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select class="form-control" id="dict" name="typeId" onchange="Dict.selectProjectType(this)">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label"><b>*</b>分类</label>
            <div class="col-sm-10" id="dictType">

            </div>
        </div>
        <div class="hr-line-dashed"></div>
        <div class="form-group">
            <label class="col-sm-2 control-label"><b>*</b>适合年级</label>
            <div class="col-sm-10" id="grade">
                <!--<label class="radio-inline"><input type="radio" value="1"/>小学</label>-->
                <!--<label class="radio-inline"><input type="radio" value="1"/>初中</label>-->
                <!--<label class="radio-inline"><input type="radio" value="1"/>高中</label>-->
            </div>
        </div>
        <div class="hr-line-dashed"></div>
        <div class="form-group">
            <label class="col-sm-2 control-label"><b>*</b>项目名称</label>
            <div class="col-sm-10">
        ...
        <div class="editBtn">
            ...
            <button type="button" class="btn btn-w-m btn-success" onclick="location.href='${prc}/main/project/list'">取消</button>
        </div>
    </form>
</div>
...
<script src="${prc}/resources/html/cms/js/info.js"></script>
